...
3．測定した周波数を2000Hz低周波数側にシフトさせ，それをpschatzmann氏の"arduino-audio-tools"を使ってPWMによる擬似サイン波として発生させました.  
4．PC側で2800Hzから3500Hzで送信し，実際には800Hzから1500Hzのトーンを発生させ，UV-K5にマイク入力し，F2Dで送信します.  
5．PC側で2800Hz以下で送信しようとしても，実際には送信されません.  
